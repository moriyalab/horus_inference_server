...
if [ $PLATFORM = "x86_64" ]; then
    echo "x86"
    docker run -it --rm --gpus all --runtime nvidia --shm-size=32G -v $ROOT/datasets:/usr/src/datasets -v $ROOT:/home/root -w /home/root --network host ghcr.io/moriyalab/ml/mlops:latest
else
